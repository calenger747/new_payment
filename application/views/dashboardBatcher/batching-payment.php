  ...
  <div class="card-body">
    <form method="POST" id="formExport" autocomplete="off" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <button type="submit" class="btn btn-sm btn-info mb-3 mr-2 float-right mdi mdi-file-excel" id="simpan1" formaction="<?= base_url('Export/export_cpv') ?>"> Export CPV XLS</button>
