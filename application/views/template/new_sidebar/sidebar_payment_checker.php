    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class=""> <a href="<?= base_url(); ?>Dashboard_Payment_Checker/case_data" aria-expanded="false"><i class="mdi mdi-database"></i><span class="hide-menu">Data Case</span></a></li> -->
                ...
                <li class="nav-small-cap">CPV</li>
                <li class=""> <a href="<?= base_url(); ?>Dashboard_Payment_Checker/list_cpv" aria-expanded="false"><i class="mdi mdi-file-excel"></i><span class="hide-menu">CPV List</span></a>
                </li>
