    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class=""> <a href="<?= base_url(); ?>Dashboard_Payment_Admin/case_data" aria-expanded="false"><i class="mdi mdi-database"></i><span class="hide-menu">Data Case</span></a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-group"></i><span class="hide-menu">Batching Case</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="<?= base_url(); ?>Dashboard_Payment_Admin/batching_case">OBV Batching</a></li>
                        <li><a href="<?= base_url(); ?>Dashboard_Payment_Admin/payment_batch">Payment Batching</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-small-cap">CPV</li>
                <li class=""> <a href="<?= base_url(); ?>Dashboard_Payment_Admin/list_cpv" aria-expanded="false"><i class="mdi mdi-file-excel"></i><span class="hide-menu">CPV List</span></a>
                </li>
