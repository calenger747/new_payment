...
class Dashboard_Batcher extends CI_Controller {
	...
	private function load($title = '', $datapath = '', $breadcumb_2 = '', $breadcumb_3 = '')
	{
		...
		$page = array(
			...
			"sidebar" => $this->load->view('template/sidebar_batcher', $get, true),
	...
	public function index()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher", $path, "Dashboard", ""),
			"content" =>$this->load->view('dashboardBatcher/index', false, true)
		);
	...
	public function case_obv()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher - OBV Case", $path, "OBV Case", "Case List OBV"),
			"content" =>$this->load->view('dashboardBatcher/case-obv', false, true)
		);
		$this->load->view('template/default_template', $data);
	}
	...
	public function batching_obv()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher - OBV Case", $path, "OBV Case", "Batching List OBV"),
			"content" =>$this->load->view('dashboardBatcher/batching-obv', false, true)
		);
		$this->load->view('template/default_template', $data);
	}
	...
	public function case_payment()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher - Payment Case", $path, "Payment Case", "Case List Pending Payment"),
			"content" =>$this->load->view('dashboardBatcher/case-payment', false, true)
		);
		$this->load->view('template/default_template', $data);
	}
	...
	public function batching_payment()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher - Payment Case", $path, "Payment Case", "Batching List Pending Payment"),
			"content" =>$this->load->view('dashboardBatcher/batching-payment', false, true)
		);
		$this->load->view('template/default_template', $data);
	}
	...
	public function history_batching()
	{
		...
		$path = "";
		$data = array(
			"page" => $this->load("Dashboard Batcher - History Batching", $path, "History Batching", ""),
			"content" =>$this->load->view('dashboardBatcher/history-batching', false, true)
		);
		$this->load->view('template/default_template', $data);
	}
